...
const validacionesProducto = [
  ...
  check("precio")
    ...
    .custom((value) => {
      if (value >= 50 && value <= 10000) {
        ...
        throw new Error("El precio debe estar entre $50 y $1000");
      }
    }),
  check("imagen")
    .notEmpty()
  ...
  check("descripcionBreve")
    ...
    .withMessage("La descripcion debe tener entre 5 y 50 caracteres"),
  check("descripcionAmplia")
    .notEmpty()
    .withMessage("La descripcion amplia es un dato obligatorio")
    .isLength({ min: 50, max: 300 })
    .withMessage("La descripcion amplia debe tener entre 50 y 300 caracteres"),
  (req, res, next) => {
